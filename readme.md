...
```
![alt text](<images/helm update.png>)
...
9. Create a split terminal and Run the code below to ensure that UpCommerce's website is up
```
...
```
Copy the IP address generated by Kubernetes for your UpCommerce website. Then enter the following command:
```
